...
<head>
    ...
    <title>Credence Security Scan Report</title>
    <style>
        * {{
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <header>
            <h1>🔍 Credence Security Scan Report</h1>
        ...
        <footer>
            <p>Generated by <strong>Credence</strong> - A security scanner for exposed sensitive files</p>
